...
#endif
            VL_FATAL_MT("/home/xyzabc/Desktop/OSCPU-test-respository/npc/vsrc/top.v", 4, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 100 tries");
        }
...
extern const VlUnpacked<CData/*4:0*/, 1024> Vcustom_cpu__ConstPool__TABLE_h75100910_0;
...
VL_ATTR_COLD void Vcustom_cpu___024root___stl_sequent__TOP__0(Vcustom_cpu___024root* vlSelf) {
    ...
    vlSelfRef.custom_cpu__DOT__lsu_mem_inst__DOT__MemWrite 
    ...
    vlSelfRef.custom_cpu__DOT__lsu_mem_inst__DOT__Read_data_Ready 
        = ((8U == (IData)(vlSelfRef.custom_cpu__DOT__MEM_EX__DOT__MEM_current_state)) 
    ...
    vlSelfRef.custom_cpu__DOT__IF_EX__DOT__MemRead 
        = ((vlSelfRef.custom_cpu__DOT__MEM_EX__DOT__EX_to_MEM_data_reg[1U] 
    ...
    vlSelfRef.custom_cpu__DOT__ifu_mem_inst__DOT__r_done 
        = ((2U == (IData)(vlSelfRef.custom_cpu__DOT__ifu_mem_inst__DOT__state)) 
           & (IData)(vlSelfRef.custom_cpu__DOT__ifu_mem_inst__DOT__Inst_Ready));
    vlSelfRef.custom_cpu__DOT__lsu_mem_inst__DOT__mem_response 
        = ((2U == (IData)(vlSelfRef.custom_cpu__DOT__lsu_mem_inst__DOT__state)) 
           & (IData)(vlSelfRef.custom_cpu__DOT__lsu_mem_inst__DOT__Read_data_Ready));
    vlSelfRef.__Vtableidx3 = ((((IData)(vlSelfRef.custom_cpu__DOT__MEM_EX__DOT__MEM_work) 
                                << 9U) | (((IData)(
                                                   (0U 
                                                    != 
                                                    (0x00000c00U 
                              ...
                              | (((2U == (IData)(vlSelfRef.custom_cpu__DOT__lsu_mem_inst__DOT__state)) 
                                  << 6U) | (((IData)(vlSelfRef.custom_cpu__DOT__EX_EX__DOT__EX_work) 
                                             << 5U) 
                                            | (IData)(vlSelfRef.custom_cpu__DOT__MEM_EX__DOT__MEM_current_state))));
    vlSelfRef.custom_cpu__DOT__MEM_EX__DOT__MEM_next_state 
        = Vcustom_cpu__ConstPool__TABLE_h75100910_0
        [vlSelfRef.__Vtableidx3];
    vlSelfRef.custom_cpu__DOT__lsu_mem_inst__DOT__mem_request 
    ...
    vlSelfRef.__Vtableidx1 = ((((IData)(vlSelfRef.custom_cpu__DOT__ifu_mem_inst__DOT__Inst_Req_Valid) 
                                << 0x0000000aU) | (
                                                   ((0U 
                                                     == (IData)(vlSelfRef.custom_cpu__DOT__ifu_mem_inst__DOT__state)) 
                                                    << 9U) 
                                                   | ((2U 
                                                       == (IData)(vlSelfRef.custom_cpu__DOT__ifu_mem_inst__DOT__state)) 
                                                      << 8U))) 
...
VL_ATTR_COLD void Vcustom_cpu___024root___ctor_var_reset(Vcustom_cpu___024root* vlSelf) {
    ...
    vlSelf->custom_cpu__DOT__IF_EX__DOT__MemRead = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3686881950143412329ull);
    ...
    vlSelf->custom_cpu__DOT__ifu_mem_inst__DOT__Inst_Req_Valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5068129882562474304ull);
    vlSelf->custom_cpu__DOT__ifu_mem_inst__DOT__Inst_Ready = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 34734773756781184ull);
    vlSelf->custom_cpu__DOT__ifu_mem_inst__DOT__state = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 17775031972587176617ull);
    vlSelf->custom_cpu__DOT__ifu_mem_inst__DOT__ifu_rdata = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 6474290227458114781ull);
    vlSelf->custom_cpu__DOT__ifu_mem_inst__DOT__delay_cnt = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 7234796406153266169ull);
    vlSelf->custom_cpu__DOT__ifu_mem_inst__DOT__ar_done = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17880314240569492798ull);
    vlSelf->custom_cpu__DOT__ifu_mem_inst__DOT__r_done = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10845446835031695732ull);
    vlSelf->custom_cpu__DOT__ifu_mem_inst__DOT__lfsr = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 4613789901825823005ull);
    ...
    vlSelf->custom_cpu__DOT__ID_EX__DOT____VdfgRegularize_h98a0652e_0_7 = 0;
    vlSelf->custom_cpu__DOT__ID_EX__DOT____VdfgRegularize_h98a0652e_0_8 = 0;
    vlSelf->custom_cpu__DOT__ID_EX__DOT____VdfgRegularize_h98a0652e_0_11 = 0;
    ...
    VL_SCOPED_RAND_RESET_W(272, vlSelf->custom_cpu__DOT__EX_EX__DOT__ID_to_EX_data, __VscopeHash, 2084467956435603514ull);
    VL_SCOPED_RAND_RESET_W(215, vlSelf->custom_cpu__DOT__EX_EX__DOT__EX_to_MEM_data, __VscopeHash, 7978946387972507071ull);
    ...
    VL_SCOPED_RAND_RESET_W(272, vlSelf->custom_cpu__DOT__EX_EX__DOT__ID_to_EX_data_reg, __VscopeHash, 7950096884356183224ull);
    ...
    vlSelf->custom_cpu__DOT__EX_EX__DOT__exec_redirect = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 8397092106480987955ull);
    ...
    vlSelf->custom_cpu__DOT__EX_EX__DOT__EX_bypath_data = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 9877768185059082360ull);
    ...
    vlSelf->custom_cpu__DOT__EX_EX__DOT__CSR_INST__DOT__ecall_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 14517425785500883623ull);
    vlSelf->custom_cpu__DOT__EX_EX__DOT__CSR_INST__DOT__csr_read_data = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 6280013882397765844ull);
    vlSelf->custom_cpu__DOT__EX_EX__DOT__CSR_INST__DOT__mcycle = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 13436174527258765648ull);
    vlSelf->custom_cpu__DOT__EX_EX__DOT__CSR_INST__DOT__mcycleh = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 13187189935870327963ull);
    vlSelf->custom_cpu__DOT__EX_EX__DOT__CSR_INST__DOT__mvendorid = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 8628775439696206955ull);
    vlSelf->custom_cpu__DOT__EX_EX__DOT__CSR_INST__DOT__marchid = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 14191938244380712231ull);
    vlSelf->custom_cpu__DOT__EX_EX__DOT__CSR_INST__DOT__mepc = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 10288120196185198653ull);
    vlSelf->custom_cpu__DOT__EX_EX__DOT__CSR_INST__DOT__mtvec = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 7798177654334163903ull);
    vlSelf->custom_cpu__DOT__EX_EX__DOT__CSR_INST__DOT__mcause = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 7755491104744346097ull);
    vlSelf->custom_cpu__DOT__EX_EX__DOT__CSR_INST__DOT__mstatus = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 15453066223362633110ull);
    vlSelf->custom_cpu__DOT__MEM_EX__DOT__MEM_to_WB_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6549950190953379427ull);
    VL_SCOPED_RAND_RESET_W(215, vlSelf->custom_cpu__DOT__MEM_EX__DOT__EX_to_MEM_data_reg, __VscopeHash, 11010710126216805396ull);
    ...
    vlSelf->custom_cpu__DOT__lsu_mem_inst__DOT__MemWrite = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16679999323139947932ull);
    vlSelf->custom_cpu__DOT__lsu_mem_inst__DOT__Read_data_Ready = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5967534161016949039ull);
    vlSelf->custom_cpu__DOT__lsu_mem_inst__DOT__state = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 2388983404802723904ull);
    vlSelf->custom_cpu__DOT__lsu_mem_inst__DOT__Read_data_reg = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 8195283609619832242ull);
    vlSelf->custom_cpu__DOT__lsu_mem_inst__DOT__delay_cnt = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 16221177726973556431ull);
    vlSelf->custom_cpu__DOT__lsu_mem_inst__DOT__mem_request = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 15609933192995641482ull);
    vlSelf->custom_cpu__DOT__lsu_mem_inst__DOT__mem_response = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2700603957837139326ull);
    vlSelf->custom_cpu__DOT__lsu_mem_inst__DOT__lfsr = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 447371750914902468ull);
