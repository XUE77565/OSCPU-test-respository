...
VL_ATTR_COLD void Vcustom_cpu___024root___ctor_var_reset(Vcustom_cpu___024root* vlSelf) {
    ...
    vlSelf->custom_cpu__DOT__ifu_mem_inst__DOT__ifu_busy = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1588007983524054732ull);
    ...
    vlSelf->custom_cpu__DOT__lsu_mem_inst__DOT__lsu_mem_busy = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9904784857026917625ull);
