...
void Vcustom_cpu___024root___nba_sequent__TOP__0(Vcustom_cpu___024root* vlSelf) {
    ...
    IData/*31:0*/ __Vdly__custom_cpu__DOT__lsu_mem_inst__DOT__Read_data_reg;
    __Vdly__custom_cpu__DOT__lsu_mem_inst__DOT__Read_data_reg = 0;
    CData/*0:0*/ __Vdly__custom_cpu__DOT__lsu_mem_inst__DOT__lsu_mem_busy;
    __Vdly__custom_cpu__DOT__lsu_mem_inst__DOT__lsu_mem_busy = 0;
    ...
    __Vdly__custom_cpu__DOT__lsu_mem_inst__DOT__Read_data_reg 
        = vlSelfRef.custom_cpu__DOT__lsu_mem_inst__DOT__Read_data_reg;
    __Vdly__custom_cpu__DOT__lsu_mem_inst__DOT__lsu_mem_busy 
        = vlSelfRef.custom_cpu__DOT__lsu_mem_inst__DOT__lsu_mem_busy;
    ...
    } else if ((vlSelfRef.custom_cpu__DOT__WB_EX__DOT__MEM_to_WB_data_reg[1U] 
    ...
    if (vlSelfRef.rst) {
        __Vdly__custom_cpu__DOT__lsu_mem_inst__DOT__Read_data_reg = 0U;
        __Vdly__custom_cpu__DOT__lsu_mem_inst__DOT__lsu_mem_busy = 0U;
    } else if (vlSelfRef.custom_cpu__DOT__lsu_mem_inst__DOT__mem_request) {
        ...
        __Vdly__custom_cpu__DOT__lsu_mem_inst__DOT__lsu_mem_busy = 1U;
    } else if (vlSelfRef.custom_cpu__DOT__lsu_mem_inst__DOT__mem_response) {
        __Vdly__custom_cpu__DOT__lsu_mem_inst__DOT__lsu_mem_busy = 0U;
    } else {
        __Vdly__custom_cpu__DOT__lsu_mem_inst__DOT__lsu_mem_busy 
            = vlSelfRef.custom_cpu__DOT__lsu_mem_inst__DOT__lsu_mem_busy;
    ...
    if (vlSelfRef.rst) {
        ...
        if (((((8U == (IData)(vlSelfRef.custom_cpu__DOT__MEM_EX__DOT__MEM_current_state)) 
               & (vlSelfRef.custom_cpu__DOT__MEM_EX__DOT__EX_to_MEM_data_reg[1U] 
                  >> 0x0000000bU)) & (IData)(vlSelfRef.custom_cpu__DOT__lsu_mem_inst__DOT__lsu_mem_busy)) 
